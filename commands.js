        ...
        if (helpStr) 
            ...
            msg.channel.send(stripIndent(
                ...
                */
                ...
                /*
                 * Prend un objet Date, par défaut à la date actuelle.
                 */
                .setTimestamp()
                .setURL("https://discord.js.org/#/docs/main/indev/class/RichEmbed")
                .addField("Ceci est un titre de champ, il peut contenir 256 caractères",
                  "Ceci est une valeur de champ, il peut contenir 2048 caractères.")
                /*
                ...
                /*
                 * Champ vide, utile pour créer de l'espace.
                 */
                .addBlankField(true)
                .addField("Inline Field 3", "Vous pouvez avoir un maximum de 25 champs.", true);
...
function embed(msg) {
    ...
    if (helpStr) 
        ...
        msg.channel.send(stripIndent(
            `
            MISE A JOUR DE [ NANO-ZIK ] LE : 22/12/2017
            
            #_CHANGELOG
            
            #_Pour_afficher_une_aide_veuillez_taper : [ !aide ] ou
            !aide [command] Exemple de commandes : || [music] || [ban] || [kick] || [supr] ||
            
            
            !afk                                   #_Mise_en_place_de_la_fonction_AFK
            !form                                  #_Pour_afficher_la_page_d_aide_a_la_mise_en_forme_de_texte
            !codebox                               #_Pour_afficher_la_page_d_aide_a_la_mise_en_forme_de_codbox
            !track                                 #_Vous_affiche_toute_les_adresses_IP_d_un_site_internet
            !color                                 #_Un_selecteur_de_couleurs_HTML
            ! [Message]                            #_Pour_afficher_vos_messages_dans_un_Embed
            !! [Message]                           #_Pour_lancer_un_vote
            !/ [Message]                           #_Pour_lancer_un_vote_ANONYME
...
function form(msg) {
    ...
    if (helpStr) 
        ...
        msg.channel.send(stripIndent(
            `
            VOICI QUELQUES MISES EN FORME DE TEXTE
            ...
            [ __souligne__ ]   
            -----------------                     
            [ __*italique souligne*__ ]  
            -----------------        
            [ __**gras souligne**__ ] 
            -----------------              
            [ __***italique gras souligne***__ ]    
